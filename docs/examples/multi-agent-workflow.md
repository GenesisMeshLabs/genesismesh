...
:alt: Multi-agent workflow demo showing researcher, router, knowledge agent, and provenance
:class: screenshot
```
...
The GIF on this page is generated by the reproducible local recorder:
