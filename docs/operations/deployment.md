...
See: [In-process smoke demo](../examples/demos-packaging.md#15-in-process-smoke-demo) and
[Live CLI process smoke demo](../examples/demos-packaging.md#16-live-cli-process-smoke-demo)
