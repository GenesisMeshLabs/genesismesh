...
3. The node submits its public key, invite token, and requested validity.
4. The Network Authority validates the invite and issues a signed certificate.
...
Expired certificates fail validation naturally. Nodes should renew before expiry
and should treat renewal failures as operationally significant.
