...
backers are being onboarded and are preparing their own proof material.
...
- It reflects a real organizational state (operators and backers in progress)
...
`docs/operators/founding-community-operators.md`:

- States that further operators and backers are being onboarded and prepare
